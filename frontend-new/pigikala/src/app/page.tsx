        ...
        <dialog ref={welcomeModalRef} id="my_modal_3" className="modal">
          <div className="modal-box border-[6px] border-info">
            ...
            <ul className="py-4 flex flex-col gap-6 font-medium">
              ...
              <li>
                شایان ذکر است که تمرکز اصلی این پروژه بر توسعه بخش بک‌اند بوده و
                این بخش با جزئیات بیشتری نسبت به فرانت‌اند تکمیل شده است. به
                همین دلیل، برخی از ویژگی‌های اپلیکیشن در سمت فرانت‌اند، به دلیل
                حجم بالای پروژه، پیاده‌سازی نشده‌اند.
              </li>
            </ul>
          </div>
        </dialog>
